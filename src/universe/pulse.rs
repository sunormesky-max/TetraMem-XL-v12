...
mod tests {
    ...
    fn reinforcing_pulse_records_hebbian() {
        ...
        assert!(result.paths_recorded > 0, "reinforcing should record Hebbian paths");
    ...
    fn multiple_pulses_build_network() {
        ...
        assert!(neighbors.len() > 0, "source should have Hebbian neighbors");
    }
    ...
    fn decay_then_reinforce_cycle() {
        ...
        assert!(after_reinforce > after_decay, "reinforcement should increase weight");
    }
}
