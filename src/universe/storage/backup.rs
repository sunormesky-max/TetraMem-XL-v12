...
impl BackupScheduler {
    ...
    fn rotate(&mut self) -> usize {
        ...
        let mut by_gen: std::collections::HashMap<u32, Vec<usize>> =
        ...
        self.backups
            .retain(|e| e.metadata.generation >= oldest_allowed);
    ...
    pub fn restore_latest(
        ...
        self.backups
            .last()
            .and_then(|entry| PersistEngine::deserialize(&entry.snapshot).ok())
    }
    ...
    pub fn restore_generation(
        ...
        let entry = self
            .backups
            .iter()
            .rfind(|e| e.metadata.generation == generation)?;
...
mod tests {
    ...
    fn backup_restore_roundtrip() {
        ...
        sched
            .create_backup(BackupTrigger::Manual, &u, &h, &mems, &CrystalEngine::new())
            .unwrap();
